...
../SEEKIN_DEV1.0/bin/seekin modelAF -i  SGVP.12K.vcf.gz -c SGVP.RefPC.coord -k 2  -o SGVP.beta  

../SEEKIN_DEV1.0/bin/seekin getAF  -i Study.onSGVP.PC.coord -b  SGVP.beta  -k 2  -o Study.10K.indvAF.vcf

tabix -p vcf ./Study.10K.indvAF.vcf.gz

../SEEKIN_DEV1.0/bin/seekin kinship -i ./Study.10K.vcf.gz  -f  ./Study.10K.indvAF.vcf.gz  -r 0.3  -m 0.05   -d DS  -p het  -l 2000  -t 3 -w 1  -o Study.het
